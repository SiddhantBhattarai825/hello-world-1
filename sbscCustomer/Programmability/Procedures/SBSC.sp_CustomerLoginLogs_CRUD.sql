...
-- =============================================
CREATE PROCEDURE [SBSC].[sp_CustomerLoginLogs_CRUD]
    @Action NVARCHAR(6),
    @UserId INT = NULL,
...
BEGIN
    ...
    BEGIN
        ...
        INSERT INTO [SBSC].[CustomerLoginLogs] (UserId, Email, LoginDateTime, Browser, IpAddress, OS, LoginAttemptsCount, LoginStatus, UserType)
