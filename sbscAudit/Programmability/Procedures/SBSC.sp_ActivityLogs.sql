...
GO
CREATE PROCEDURE [SBSC].[sp_ActivityLogs]
    @Action NVARCHAR(10),
...
BEGIN
    ...
    BEGIN
        BEGIN TRY
            ...
            INSERT INTO [SBSC].[ActivityLogDetail] (ActivityLogId, ColumnName, OldValue, NewValue)
            SELECT 
                @ActivityLogId,
